...
class UserListControllerTest {
    ...
    void 로그인_후_메인페이지요청_cookie_검사() throws Exception {
        ...
        assertThat(httpResponse.getPath()).isEqualTo(ViewLocation.TEMPLATE.getLocation() + "/user/list.html");
    ...
    void 로그인하지않고_user_list_페이지_요청_login_페이지로_리다이렉트() throws Exception {
        ...
        assertThat(httpResponse.getPath()).isEqualTo(ViewLocation.TEMPLATE.getLocation() + "/user/login.html");
